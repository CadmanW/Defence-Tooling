...
func main() {
	...
	keyPath := flag.String("key", "", "Path to SSH private key for decrypting encrypted chunks")
	...
	flag.Usage = func() {
		...
		fmt.Fprintf(os.Stderr, "    -key /path/to/ssh/private/key   # only needed for encrypted chunks\n")
	}
