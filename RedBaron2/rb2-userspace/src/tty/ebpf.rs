...
#[inline(always)]
const unsafe fn ru16(p: *const u16) -> u16 {
    unsafe { core::ptr::read_unaligned(p) }
}

#[inline(always)]
const unsafe fn ru32(p: *const u32) -> u32 {
    unsafe { core::ptr::read_unaligned(p) }
}

#[inline(always)]
const unsafe fn ru64(p: *const u64) -> u64 {
    unsafe { core::ptr::read_unaligned(p) }
}
...
pub fn parse_tty_write_event(bytes: &[u8]) -> anyhow::Result<ParsedTtyWrite> {
    ...
    Ok(ParsedTtyWrite {
        ...
        audit_loginuid: unsafe { ru32(core::ptr::addr_of!(fixed.pids.audit_loginuid)) },
        audit_sessionid: unsafe { ru32(core::ptr::addr_of!(fixed.pids.audit_sessionid)) },
